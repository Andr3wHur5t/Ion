 ...
 */
@property(weak, readwrite) id<FODataModelDelegate> delegate;
...
/*!
 @brief Inserts the data at the inputted index, and shifts the data currently at
 the inputted index up
