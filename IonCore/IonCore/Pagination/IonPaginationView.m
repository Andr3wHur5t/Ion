...
#pragma mark Page References
/**
 * A Reference to the first active page.
 */
...
/**
 * A Reference to the last active page.
 */
...
- (NSMutableArray *)activePages {
  if (!_activePages) _activePages = [[NSMutableArray alloc] init];
  return _activePages;
}
