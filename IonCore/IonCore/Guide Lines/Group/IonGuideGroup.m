...
static NSString* sIonGuideLine_Origin_Horiz =
    @"IonGuideLine_InternialOrigin_Horiz";
static NSString* sIonGuideLine_Origin_Vert =
    @"IonGuideLine_InternialOrigin_Vert";
...
static NSString* sIonGuideLine_TwoThirds_Horiz =
    @"IonGuideLine_TwoThirds_Horiz";
...
static NSString* sIonGuideLine_ThreeForths_Horiz =
    @"IonGuideLine_ThreeForths_Horiz";
static NSString* sIonGuideLine_ThreeForths_Vert =
    @"IonGuideLine_ThreeForths_Vert";
...
static NSString* sIonGuideLine_CornerRadius_Horiz =
    @"IonGuideLine_CornerRadius_Horiz";
static NSString* sIonGuideLine_CornerRadius_Vert =
    @"IonGuideLine_CornerRadius_Vert";
...
- (instancetype)initWithView:(UIView*)view {
  ...
  if (self) {
    _viewObserver =
        [FOKeyValueObserver observeObject:view
                                  keyPath:@"frame"
                                   target:self
...
- (void)updateFrameToMatchChange:(NSDictionary*)change {
  ...
  if (!rect || ![rect isKindOfClass:[NSValue class]]) return;
 ...
 * @return {NSMutableDictionary*} cache of guides.
 */
...
- (IonGuideLine*)guideInParentContext:(IonGuideLine*)guide
  ...
  originGuide =
      (mode == IonGuideLineFrameMode_Horizontal ? self.originExternalGuideHoriz
...
- (void)cacheGuide:(IonGuideLine*)guide withKey:(NSString*)key {
  ...
  if (!key || ![key isKindOfClass:[NSString class]] || !guide ||
      ![guide isKindOfClass:[IonGuideLine class]])
    return;
...
- (IonGuideLine*)oneForthGuideHoriz {
  ...
  if (!obj) {
    obj =
        [IonGuideLine guideWithTargetRectSize:self
...
- (IonGuideLine*)originExternalGuideHoriz {
  ...
  if (!obj) {
    obj = [IonGuideLine
        guideWithTargetRectPosition:self
                   usingRectKeyPath:sIonGuideGroup_FrameKey
                             amount:0.0f
                            andMode:IonGuideLineFrameMode_Horizontal];
...
- (IonGuideLine*)threeForthsExternalGuideHoriz {
  IonGuideLine* obj =
      [self externalGuideForKey:sIonGuideLine_ThreeForths_Horiz];
  if (!obj) {
...
- (NSString*)description {
  return [NSString
      stringWithFormat:@"Active Guides: \"%lu\", Current Frame: \"%@\"",
                       (unsigned long)[self.cachedGuideLines count],
                       NSStringFromCGRect(_frame)];
}
