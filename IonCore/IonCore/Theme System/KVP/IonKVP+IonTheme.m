 ...
 * @return {UIColor*} representation, or NULL if incorect type.
 */
- (UIColor*) toColor {
 ...
 * @return {IonStyle*} representation, or NULL if incorect type.
 */
- (IonStyle*) toStyle {
 ...
 * @return {IonThemePointer*} representation, or NULL if incorect type.
 */
