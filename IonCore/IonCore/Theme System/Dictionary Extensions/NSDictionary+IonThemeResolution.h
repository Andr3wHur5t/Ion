 ...
 * @return {UIColor*} the resulting color, or NULL if Invalid.
 */
 ...
 * @return {IonGradientConfiguration*} the resulting gradientConfiguration, or NULL if Invalid.
 */
 ...
 * @param {IonTheme*} the theme to get references from.
 * @return {NSArray*} of the resolved color weights, or NULL if invalid.
 */
 ...
 * @param {IonTheme*} the theme to get references from.
 * @return {NSArray*} of the resolved color weight dictionary, or NULL if invalid.
 */
